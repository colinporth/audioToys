...
namespace ReSampler {
  ...
  // filters based on E-weighted curves from 'Minimally Audible Noise Shaping' (*)
  //{{{
  ...
  // filters based on F-weighted curves from 'Psychoacoustically Optimal Noise Shaping' (**)
