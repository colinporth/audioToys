// conversioninfo.h defines the ConversionInfo struct, for holding conversion parameters.
//{{{
...
namespace ReSampler {
  ...
  typedef enum { relaxed, normal, steep, custom } LPFMode;
  //{{{
  ...
  static_assert (std::is_copy_constructible<ConversionInfo>::value, "ConversionInfo must be copy constructible");
  static_assert (std::is_copy_assignable<ConversionInfo>::value, "ConversionInfo must be copy assignable");
